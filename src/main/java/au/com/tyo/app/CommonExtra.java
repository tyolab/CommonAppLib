    ...
    public static void putExtra(Intent intent, String key, Object data) {
        if (data != null) {
            if (data instanceof String) {
                ...
                Serializable obj = (Serializable) data;
                intent.putExtra(key, obj);
            }
            else if (data instanceof Parcelable[]) {
                Parcelable[] obj = (Parcelable[]) data;
                intent.putExtra(key, obj);
            }
            else {
                // noting
                throw new IllegalArgumentException("Unsupported data type: " + data.getClass().getSimpleName() + ", assign the value yourself");
            }
        }
    }
